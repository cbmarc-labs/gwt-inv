 ...
 *
 */
public class ListParteView extends Composite 
		implements ListPartePresenter.Display {
	interface uiBinder extends UiBinder<Widget, ListParteView> {}
	 ...
	 */
	@Override
	public void setData(List<Parte> data) {
		table.removeAllRows();
